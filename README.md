...
A Calibre e-Books application operating natively on MIPS Linux OpenWRT 12.09. Pronounced *ooh-guy*, this application enables rapid sharing of multimedia collections through any old router. With `Ugai`, you can establish a portable, wireless server in under a minute, all for less than $10 and using under 5 watts of power. No advanced IT skills required! 
